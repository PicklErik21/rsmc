  ...
  <form on:submit={handleSubmit} class="mt-16 mb-10">
    <div class="grid gap-6 sm:grid-cols-2">
      <div class="relative z-0">
        ...
        <label class="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-white peer-focus:dark:text-white font-anon">Your name</label>
      </div>
      <div class="relative z-0">
